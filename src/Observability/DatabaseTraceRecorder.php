...
{
    public function __construct(private readonly ConnectionInterface $db,private readonly TelemetryExporter $exporter){}
    public function record(string $traceId,string $span,string $event,array $attributes=[],?float $durationMs=null):void
    {
        ...
        $this->exporter->export($traceId,$span,$event,$attributes,$durationMs);
    }
}
